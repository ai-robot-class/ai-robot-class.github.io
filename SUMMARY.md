...
* [Frank Zhao · 主页](README.md)

## 🤖 课程一 · AI 机器人 (AI Robotics)

* [课程简介](courses/ai-robot/README.md)
* [课程更新总结与项目选题](PROJECT_SUMMARY.md)
* [GitHub Actions 自动评价系统使用指南](GITHUB_ACTIONS_GUIDE.md)
...
* 教学内容
  ...
  * [Week 13：四足机器人入门](content/week13.md)
  * [Week 14：期末项目实施 — 手机遥控 + 迷宫探索（小组项目）](content/week14.md)

## 🧠 课程二 · 强化学习 (Reinforcement Learning)

* [课程简介](courses/rl/README.md)
* [第一部分 · Python 与线性代数基础](courses/rl/part1-linear-algebra.md)
* [第二部分 · 马尔可夫决策过程 (MDP)](courses/rl/part2-mdp.md)
* [第三部分 · 强化学习基础概念](courses/rl/part3-rl-basics.md)
* [第四部分 · 应用环境示例](courses/rl/part4-environments.md)
* [第五部分 · 各式各样的强化学习算法](courses/rl/part5-algorithms.md)
